...
import org.globaltester.testspecification.importer.*;
import org.globaltester.testspecification.ui.wizards.GT2WizardProjectsImportPage;
/**
...
public class ImportGT2ScriptsWizard extends Wizard implements
        IImportWizard {
    private static final String EXTERNAL_PROJECT_SECTION = "ExternalProjectImportWizard";//$NON-NLS-1$
	
	private GT2WizardProjectsImportPage mainPage;
     ...
     * @since 3.5
     */
    public ImportGT2ScriptsWizard(String initialPath)
    {
        super();
    ...
    public void addPages() {
        super.addPages();
		mainPage = new GT2WizardProjectsImportPage(
    ...
    public boolean performFinish() {
    	Object[] projectsToImport = mainPage.getProjectsList().getCheckedElements();
    	for (int i = 0; i < projectsToImport.length; i++) {
			GT2TestProjectImporter.importProject(projectsToImport[i]);
		}
